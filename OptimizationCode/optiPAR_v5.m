...
min_c3 = [0.1 0.08]; %default = -0.074;
max_c3 = [0.2 0.3]; %default = 0.247;
step_c3 = [0.1 0.1];

%% C4 - y position of 2nd Mean Line control point
min_c4 = [0.1 0.15]; %default = -0.102;
max_c4 = [0.2 0.3]; %default = 0.206;
step_c4 = [0.1 0.1];
...
min_rho = [0.5 0.175];
max_rho = [0.9 0.4]; %default = 1.4944;
step_rho = [0.1 0.1];
