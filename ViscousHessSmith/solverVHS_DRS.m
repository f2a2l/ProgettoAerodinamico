classdef solverVHS_DRS
    ...
    methods
        ...
        function obj = solverVHS_DRS(npoint, aname, alpha, varargin)
            ...
            elseif length(alpha) > 1 && length(varargin) == 2
                dist = varargin{1};
                crel = varargin{2};
                [Cl, Cd, xmax, ymax, Cp, v, maxdCp, x, y, p, p1, SOL, metaPan, nairfoils] = solverHS_DRS(npoint, aname, alpha, dist, crel);
            else
