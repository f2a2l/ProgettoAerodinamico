...
% function [T_sector] = sector(CL_wing, CD_wing)
% SECTOR is a function 

% Generic inputs
model

% Specific inputs --> FIXED for Baku Circuit
L = 850;                 % [m]       sector length --> 630 m of DRS zone
...
u_max = max_speed(CD(1));   % [m/s]    maximum car speed
